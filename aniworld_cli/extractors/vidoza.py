...
it is intentionally left unimplemented until vidoza reappears on the site.
"""
...
def extract(embed_url: str, session: requests.Session) -> Stream | None:
    """Return None until a live vidoza embed fixture is available."""
    return None
